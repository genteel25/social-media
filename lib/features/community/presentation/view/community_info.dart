...
class CommunityInfoView extends StatelessWidget
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      extendBody: true,
      body: BlocBuilder<CommunityDashboardBloc, CommunityDashboardState>(
        builder: (context, state) {
          return state.maybeWhen(
            loading: () => const Center(
              child: CircularProgressIndicator(),
            ),
            communityDashboardSuccess: (data) => DefaultTabController(
              length: 3,
              child: SafeArea(
                bottom: false,
                child: Stack(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              margin: REdgeInsets.only(left: 20, top: 12),
                              width: 32.w,
                              height: 32.h,
