...
class DiscoverPeopleView
    extends StatelessView<DiscoverPeopleScreen, DiscoverPeopleController> {
  const DiscoverPeopleView(DiscoverPeopleController state, {Key? key})
      : super(state, key: key);
