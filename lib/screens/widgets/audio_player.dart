          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                    child: Padding(
                  padding: REdgeInsets.symmetric(horizontal: 14.5, vertical: 0),
                  child: Stack(
                                  ...
                                  children: [
                                    Expanded(
                                      child: ProgressBar(
                                        ...
                                        thumbRadius: 0,
                                        thumbGlowRadius: 7.r,
                                        thumbGlowColor: const Color(0xffeaf4f4)
                                            .withOpacity(0.7),
                                        progressBarColor: AppColors.skyWhite,
                                        baseBarColor: const Color(0xffeaf4f4)
                                            .withOpacity(0.2),
                                      ),
                                    ),
                                  ],
                              ...
                              StreamBuilder(
                                  ...
                                  builder: (context, snapshot) {
                                    return GestureDetector(
                                      onTap: () =>
                                          setPlaybackSpeed(snapshot.data ?? 1),
                                      child: Container(
                                        alignment: Alignment.center,
                                        width: 20.w,
                                        height: 20.h,
